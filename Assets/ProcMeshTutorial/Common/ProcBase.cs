...
public abstract class ProcBase : MonoBehaviour
{
    ...
    protected void BuildQuadDouble(MeshBuilder meshBuilder, Vector3 offset, Vector3 widthDir, Vector3 lengthDir)
    {
        BuildQuad(meshBuilder, offset, widthDir, lengthDir);
        BuildQuad(meshBuilder, offset, lengthDir, widthDir);
    }
